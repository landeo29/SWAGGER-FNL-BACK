...
class OpenaiController {
    constructor() {
        ...
        this.generateProgramsWithGemini = (user_id, username, age_range, hierarchical_level, responsability_level, gender, estres_nivel, resumenRespuestas) => __awaiter(this, void 0, void 0, function* () {
            var _a;
      ...
      `;
                ...
                while (intentos < 10 && !flag) {
                    try {
                        ...
                        yield userprograma_1.UserPrograma.bulkCreate(registros);
                        flag = true;
                    }
                    catch (error) {
        ...
        this.generatePrograms = (user_id, username, age_range, hierarchical_level, responsability_level, gender, estres_nivel, resumenRespuestas) => __awaiter(this, void 0, void 0, function* () {
        ...
        `,
                ...
                let gptResponse = yield axios_1.default.post(url, {
                    model: "gpt-4",
        ...
        this.analyzeMessage = (mensaje) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const apiKey = process.env.OPENAI_API_KEY;
            const url = "https://api.openai.com/v1/chat/completions";
            const systemMessage = {
    ...
    `,
            ...
            try {
                ...
                console.error("Error al obtener respuesta del bot:", ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
                throw new Error(`Error al obtener respuesta del bot: ${((_d = (_c = (_b = error.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.message) || error.message}`);
            }
        });
        this.getBotResponse = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
      ...
      `,
        ...
        this.analyzeMessageWithGemini = (mensaje) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e;
            const apiKey = (_a = process.env.GEMINI_API_KEY) !== null && _a !== void 0 ? _a : "";
            const prompt = `
    Analiza el siguiente mensaje, de parte de los usuarios de nuestra app para ayuda psicológica en el trabajo:
    ...
    `;
            try {
                ...
                console.error("Error al obtener respuesta del bot:", ((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || error.message);
                throw new Error(`Error al obtener respuesta del bot: ${((_e = (_d = (_c = error.response) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.error) === null || _e === void 0 ? void 0 : _e.message) || error.message}`);
            }
        });
        ...
        `;
                ...
                const analisis = yield this.analyzeMessageWithGemini(prompt);
